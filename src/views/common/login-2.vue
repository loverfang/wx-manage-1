<template>
  <div class="login-container" ref="main" :style="mainStyle">
...
export default {
  ...
  methods: {
    ...
    setMainMarginTop: function () {
        ...
        //let mainHeight = window.getComputedStyle(this.$refs.main).height // 100px
        this.mainStyle.marginTop = (currentScreenHeight - 476) / 2 + 'px';
        debugger
    }
  },
};
